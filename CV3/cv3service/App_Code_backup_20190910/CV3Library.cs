...
public class CV3Library
{
        ...
        while (reader.Read())
        {
            ...
            else if (reader.NodeType == XmlNodeType.Text || reader.NodeType == XmlNodeType.CDATA)
            {
                ...
                else if (curInfo == "customField")
                {
                    ...
                    if (rValue.Contains("ordersms"))
                    {
                        ord.Ordersms = rValue.Split('=')[1];
                    }
                    if (rValue.Contains("promotionsms"))
                    {
                        ord.Promotionsms = rValue.Split('=')[1];
                    }
                    if (rValue.Contains("taxwebref"))
                    {
                        ord.SalesTaxRefNumber = rValue.Split('=')[1];
                    }
                    else
    ...
    public class Order
    {
        ...
        public string Promotionsms;
        public string SalesTaxRefNumber;
        public Order()
        {
            OrderID = "";
            TotalPrice = 0.0;
