...
public class VisaCheckoutService
{
    ...
    public CardInfo ReturnCardInfo(string callid,  string brandCode)
    {
        ...
        CardInfo custInfo = new CardInfo(creditCardNumberNode.InnerText, cardBrandNode.InnerText, cardExpDateMonthNode.InnerText, cardExpDateYearNode.InnerText, cardAddressNode.InnerText, cardZip.InnerText, "success");
        return custInfo;
    }
